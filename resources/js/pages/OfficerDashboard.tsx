...
import { Package, Clock, Truck, CheckCircle2, Eye } from 'lucide-react';
    ...
    return (
        <OfficerLayout breadcrumbs={[{ title: 'Officer Dashboard', href: '/officer/dashboard' }]}>
            ...
            <div className="flex h-full flex-1 flex-col gap-2 p-4 lg:p-6">
                ...
                <div className="rounded-xl border bg-white shadow-sm dark:bg-gray-800 dark:border-gray-700 mt-4 overflow-hidden">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm whitespace-nowrap">
                            ...
                            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                {recent_deliveries?.length > 0 ? recent_deliveries.map((delivery: Delivery) => (
                                    <tr key={delivery.id}>
                                        ...
                                        <td className="px-6 py-4">
                                            <Link href={`/officer/deliveries/${delivery.id}`} className="text-indigo-600 hover:text-indigo-700 font-medium flex items-center gap-2">
